...
module.exports = function serverError (data, options) {
  ...
  // work, just send JSON.
  if (options.view) {
    return res.view(options.view, { data: viewData, title: 'Belső szerverhiba', loggedin: req.session.me ? true : false });
  }

  // If no second argument provided, try to serve the default view,
  // but fall back to sending JSON(P) if any errors occur.
  else return res.view('500', { data: viewData, title: 'Belső szerverhiba', loggedin: req.session.me ? true : false }, function (err, html) {
